package by.idiscount.ucrop.view.widget;
...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mProgressLinePaint.setColor(getResources().getColor(by.idiscount.ucrop.R.color.ucrop_color_progress_wheel_line));
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), by.idiscount.ucrop.R.color.ucrop_color_progress_wheel_line);

        mProgressLineWidth = getContext().getResources().getDimensionPixelSize(by.idiscount.ucrop.R.dimen.ucrop_width_horizontal_wheel_progress_line);
        mProgressLineHeight = getContext().getResources().getDimensionPixelSize(by.idiscount.ucrop.R.dimen.ucrop_height_horizontal_wheel_progress_line);
        mProgressLineMargin = getContext().getResources().getDimensionPixelSize(by.idiscount.ucrop.R.dimen.ucrop_margin_horizontal_wheel_progress_line);
